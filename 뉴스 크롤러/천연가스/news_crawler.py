...
def Crawling() :
    ...
    old_df = pd.read_csv('/Users/anjaeu/Desktop/Contents/Elastic/엘라스틱 프로젝트/뉴스 크롤러/천연가스/news_data_natural_gas.csv', encoding='utf-8')
    ...
    old_df.append(new_data).to_csv('/Users/anjaeu/Desktop/Contents/Elastic/엘라스틱 프로젝트/뉴스 크롤러/천연가스/news_data_natural_gas.csv', encoding='utf-8', index=False)
